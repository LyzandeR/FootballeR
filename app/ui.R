shinyUI(navbarPage(title='FootballeR', fluid = FALSE, collapsible = FALSE,
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      sliderInput('date_range', "Select the Date Range", value=c(as.IDate('2015-08-01'), as.IDate('2016-06-30')),
                  min=as.IDate('2015-08-01'), max=as.IDate('2016-06-30')),
    ...
    tabsetPanel(
      ...
      tabPanel('Goals', 
               ...
               fixedRow(
                  ...
                  column(br(), br(),selectInput('team', 'Select Team',      choices=init_teams   ,  selected='Arsenal'),
      ...
      tabPanel('Results',
               ...
               fixedRow(
                  ...
                  column(br(), br(),selectInput('result_team', 'Select Team'     , choices=init_teams      , selected='Arsenal'),
      ...
      tabPanel('Over / Under',
               ...
               fixedRow(
                 ...
                 column(br(), br(), selectInput('OU_team', 'Select Team'   , choices=init_teams                 , selected='Arsenal'),
      ...
      tabPanel('Cards / Fouls',
               ...
               fixedRow(
                 ...
                 column(br(),br(),selectInput('cards_team', 'Select Team'      , choices=init_teams    , selected='Arsenal'),
      ...
      tabPanel('Corners',
               ...
               fixedRow(
                 ...
                 column(br(),br(),selectInput('corner_team', 'Select Team'     , choices=init_teams              , selected='Arsenal'),
