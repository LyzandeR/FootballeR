                     ...
                     div(id = 'parent',
                       div(class = "image", 
                           highchartOutput("OU_35",
                                           ...
                                           width = "320px")),
                       div(class = "image", 
                           style = "width:320px;background:white;height:300px;"),
                       div(class = "image", 
                     ...
                     fixedRow(
                       ...
                       column(br(),
                              ...
                              selectInput('cornerOU',
                                          'Select Over/Under', 
                                          choices = c('Corners O/U  5.5',
                                                      'Corners O/U  8.5',
                                                      'Corners O/U 10.5',
                                                      'Corners O/U 13.5'), 
                                          selected = 'Over/Under 5.5')),
